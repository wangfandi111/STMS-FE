    ...
    children: [
      // dashboard
      {
        ...
        children: [
          ...
          //   meta: { title: '任务详情', permission: [ 'profile' ] }
          // }
          // {
      ...
      // forms
      {
        ...
        component: PageView,
        meta: { title: '学生信息', icon: 'form', permission: [ 'dashboard' ] },
        children: [
          {
            path: '/student/student-list/:pageNo([1-9]\\d*)?',
            name: 'TableListWrapper',
            hideChildrenInMenu: true, // 强制显示 MenuItem 而不是 SubMenu
            component: () => import('@/views/list/TableList'),
            meta: { title: '学生列表', keepAlive: true, permission: [ 'dashboard' ] }
          }
          // {
          //   path: '/form/step-form',
          //   name: 'StepForm',
